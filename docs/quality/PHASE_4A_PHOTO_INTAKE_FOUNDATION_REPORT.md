...
- The isolated logical restore completed successfully while recapturing the reviewed schema, catalog, normalized-data, archive, and restored-schema fingerprints. The final committed-source guard is rerun after the checkpoint commit.
