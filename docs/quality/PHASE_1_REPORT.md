...
| Check                                                         | Result                                                                                                                                                                                                                                                                                                                                                               |
| ------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Formatting, ESLint, TypeScript, unit/component/contract suite | `npm run check`: pass; 17 files and 194 tests                                                                                                                                                                                                                                                                                                                        |
...
| Local browser matrix                                          | `npm run test:e2e`: atomic webpack build and private-artifact scan passed; 149 browser checks passed, 55 intentional project-specific skips, 0 failures                                                                                                                                                                                                              |
...
| Accessibility                                                 | Serious/critical axe findings: 0 in Family, personal, People, Family Settings and its short-screen review states, Memories landing, On This Day, year, empty-memory, chooser, written composer, video-feasibility route plus ready/player state, and global-error states                                                                                             |
| Mobile layout                                                 | No horizontal overflow and no visible target below 44 CSS px at 320×568 in all primary, Settings, Memories, and video-feasibility screens; deep actions clear the fixed navigation; 320×350 composer, detail, Settings review, and video-player controls remain reachable; the 640×450 CSS viewport equivalent of a 1280×900 window at 200% reflows in one dimension |
...
- The first isolated GitHub run must execute the prepared functional browser projects and calibrate the reviewed local snapshots against the x64 macOS 15 host. The complete CI list contains 268 checks across 11 files, including WebKit and project-specific visual cases. Baseline differences must be inspected and approved; CI never updates them automatically.
