...
| `moments`            | `id`, `circle_id`, `journal_person_id`, `recorded_by_user_id`, immutable type, optional title, body, explicit manual place label, authoritative `occurred_on`, optional `occurred_at`/time/timezone, date precision, and lifecycle timestamps.                                             |
