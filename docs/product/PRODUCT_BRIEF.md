...
| `circle_memberships`        | Access principal: `circle_id`, `user_id`, linked `person_id`, `role` (`organizer`, `member`, `operations`), `status`, `revoked_at`. Unique circle/user pair. Operations is an authenticated ops presence, not a family journal person.                                                                                                                                                                      |
