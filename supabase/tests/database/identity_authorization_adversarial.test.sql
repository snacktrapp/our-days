...
select is(
  ...
  array[
    ...
    'create_written_moment(circle_id uuid, journal_person_id uuid, body text, occurred_on date, occurred_at timestamp with time zone, occurred_timezone text, audience text, circle_ids uuid[])',
    ...
    'reserve_photo_moment(circle_id uuid, journal_person_id uuid, body text, place_name text, tagged_person_ids uuid[], occurred_on date, occurred_at timestamp with time zone, occurred_timezone text, request_key uuid, audience text, circle_ids uuid[])',
    'reserve_video_moment(circle_id uuid, journal_person_id uuid, body text, place_name text, tagged_person_ids uuid[], occurred_on date, expected_mime_type text, expected_size_bytes bigint, duration_ms integer, occurred_at timestamp with time zone, occurred_timezone text, request_key uuid, audience text, circle_ids uuid[], existing_moment_id uuid)',
