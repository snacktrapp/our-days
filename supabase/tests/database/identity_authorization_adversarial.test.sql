...
select is(
  ...
  array[
    ...
    'create_insight_moment(circle_id uuid, quote text, attribution text, source_url text, occurred_on date, occurred_at timestamp with time zone, occurred_timezone text)',
...
select is(
  ...
  array[
    ...
    'create_insight_moment(requested_circle_id uuid, requested_quote text, requested_attribution text, requested_source_url text, requested_occurred_on date, requested_occurred_at timestamp with time zone, requested_occurred_timezone text)',
