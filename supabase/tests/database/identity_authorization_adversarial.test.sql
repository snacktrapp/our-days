...
select is(
  ...
  array[
    ...
    'find_daily_prayer_moment(occurred_on date)',
    ...
    'set_just_me_catalog_preference(item_id text, enabled boolean)',
...
select is(
  ...
  array[
    ...
    'find_daily_prayer_moment:authenticated:EXECUTE',
    ...
    'list_just_me_catalog_preferences:authenticated:EXECUTE',
    ...
    'set_just_me_catalog_preference:authenticated:EXECUTE',
...
select is(
  ...
  array[
    ...
    'create_circle(requested_name text)',
    ...
    'deliver_insight_source_item_to_user(requested_source_item_id uuid, requested_user_id uuid)',
    'deliver_insight_source_to_subscribers(requested_source_item_id uuid)',
    'deliver_pending_insight_sources_to_user(requested_user_id uuid, requested_source_id text)',
    ...
    'find_daily_prayer_moment(requested_occurred_on date)',
    ...
    'set_just_me_catalog_preference(requested_item_id text, requested_enabled boolean)',
