...
select is(
  ...
  array[
    ...
    'content_mentions:r',
    'moment_circles:r',
    'moment_note_reactions:r',
    'moment_notes:r',
    'moment_people:r',
    'moment_photos:r',
    'moment_reactions:r',
    'moment_video_posters:r',
    'moment_videos:r',
    'moments:r',
    'people:r',
    'person_guardians:r'
...
select is(
  ...
  array[
    ...
    'content_mentions:authenticated:SELECT',
    'moment_circles:authenticated:SELECT',
    'moment_note_reactions:authenticated:SELECT',
    ...
    'moment_video_posters:authenticated:SELECT',
    'moment_videos:authenticated:SELECT',
...
select is(
  ...
  array[
    ...
    'claim_mention_push_deliveries(requested_moment_id uuid, requested_note_id uuid)',
    'claim_note_reaction_push_deliveries(requested_note_id uuid)',
    ...
    'create_circle(circle_name text, source_circle_id uuid)',
    'create_family_moment(circle_id uuid, journal_person_id uuid, moment_kind text, moment_title text, moment_body text, place_name text, tagged_person_ids uuid[], occurred_on date, occurred_at timestamp with time zone, occurred_timezone text, latitude double precision, longitude double precision, audience text, circle_ids uuid[], mentioned_user_ids uuid[], mention_starts integer[], mention_ends integer[])',
    'create_insight_moment(circle_id uuid, quote text, attribution text, source_url text, occurred_on date, occurred_at timestamp with time zone, occurred_timezone text, audience text, circle_ids uuid[])',
    'create_invitation(circle_id uuid, display_name text, email text, reinvite_membership_id uuid)',
    'create_just_me_insight_for_member(circle_id uuid, member_person_id uuid, quote text, attribution text, source_url text, occurred_on date, occurred_at timestamp with time zone, occurred_timezone text)',
    'create_managed_person(circle_id uuid, display_name text, accent_token text)',
    'create_moment_note(moment_id uuid, body text, mentioned_user_ids uuid[], mention_starts integer[], mention_ends integer[])',
    'create_written_moment(circle_id uuid, journal_person_id uuid, body text, occurred_on date, occurred_at timestamp with time zone, occurred_timezone text, audience text, circle_ids uuid[], mentioned_user_ids uuid[], mention_starts integer[], mention_ends integer[])',
    'delete_empty_circle(target_circle_id uuid, expected_name text)',
    'delete_entry_draft(draft_id uuid)',
    'delete_web_push_subscription(endpoint text)',
    'enrich_timeline_page(moment_ids uuid[])',
    'finalize_video_moment(request_id uuid)',
    ...
    'get_entry_draft(draft_id uuid)',
    'get_moment_conversation(moment_id uuid)',
    'get_photo_moment_delivery(moment_id uuid)',
    'get_photo_moment_status(intake_id uuid)',
    'get_photo_moments_delivery(moment_ids uuid[])',
    'get_video_moment_delivery(moment_id uuid)',
    'get_video_moment_poster_delivery(moment_id uuid)',
    'list_all_timeline_moments(cursor_occurred_on date, cursor_has_precise_time boolean, cursor_occurred_at timestamp with time zone, cursor_moment_id uuid, page_size integer, snapshot_at timestamp with time zone)',
    'list_entry_drafts()',
    'list_existing_circle_members(source_circle_id uuid, target_circle_id uuid)',
    ...
    'list_my_photo_intakes(circle_id uuid)',
    ...
    'list_visible_content_mentions(moment_ids uuid[])',
    'list_web_push_deliveries(activity_kind text, activity_id uuid)',
    ...
    'remove_moment_photo(moment_id uuid, photo_id uuid)',
    'reorder_moment_photos(moment_id uuid, photo_ids uuid[])',
    ...
    'reserve_photo_moment(circle_id uuid, journal_person_id uuid, body text, place_name text, tagged_person_ids uuid[], occurred_on date, occurred_at timestamp with time zone, occurred_timezone text, request_key uuid, audience text, circle_ids uuid[], mentioned_user_ids uuid[], mention_starts integer[], mention_ends integer[])',
    'reserve_video_moment(circle_id uuid, journal_person_id uuid, body text, place_name text, tagged_person_ids uuid[], occurred_on date, expected_mime_type text, expected_size_bytes bigint, duration_ms integer, occurred_at timestamp with time zone, occurred_timezone text, request_key uuid, audience text, circle_ids uuid[], existing_moment_id uuid, mentioned_user_ids uuid[], mention_starts integer[], mention_ends integer[])',
    'revoke_invitation(invitation_id uuid)',
    'revoke_membership(membership_id uuid)',
    'save_entry_draft(draft_id uuid, kind text, title text, body text, audience text, circle_ids uuid[], journal_person_id uuid, tagged_person_ids uuid[], place_name text, latitude double precision, longitude double precision, occurred_on date, occurred_time text, occurred_timezone text, media jsonb, verse jsonb)',
    'save_web_push_subscription(endpoint text, p256dh text, auth text)',
    'set_circle_archived(target_circle_id uuid, archive boolean)',
    'set_membership_role(membership_id uuid, role text)',
    'set_moment_audience(moment_id uuid, expected_revision bigint, audience text, circle_ids uuid[])',
    'set_moment_note_heart(note_id uuid, hearted boolean)',
    ...
    'update_family_moment(moment_id uuid, expected_revision bigint, moment_title text, moment_body text, place_name text, tagged_person_ids uuid[], occurred_on date, occurred_at timestamp with time zone, occurred_timezone text, latitude double precision, longitude double precision, audience text, mentioned_user_ids uuid[], mention_starts integer[], mention_ends integer[])',
    'update_moment_note(note_id uuid, expected_revision bigint, body text, mentioned_user_ids uuid[], mention_starts integer[], mention_ends integer[])',
    'update_written_moment(moment_id uuid, expected_revision bigint, body text, occurred_on date, occurred_at timestamp with time zone, occurred_timezone text, mentioned_user_ids uuid[], mention_starts integer[], mention_ends integer[])',
...
select is(
  ...
  array[
    ...
    'add_existing_circle_member:authenticated:EXECUTE',
    'attach_photo_to_moment:authenticated:EXECUTE',
    'attach_video_moment_poster:authenticated:EXECUTE',
    'cancel_photo_intake:authenticated:EXECUTE',
    'claim_mention_push_deliveries:authenticated:EXECUTE',
    'claim_note_reaction_push_deliveries:authenticated:EXECUTE',
    ...
    'create_circle:authenticated:EXECUTE',
    'create_family_moment:authenticated:EXECUTE',
    'create_insight_moment:authenticated:EXECUTE',
    'create_just_me_insight_for_member:authenticated:EXECUTE',
    ...
    'delete_empty_circle:authenticated:EXECUTE',
    'delete_entry_draft:authenticated:EXECUTE',
    'delete_web_push_subscription:authenticated:EXECUTE',
    'enrich_timeline_page:authenticated:EXECUTE',
    'finalize_video_moment:authenticated:EXECUTE',
    'flag_photo_display_derivative_for_review:authenticated:EXECUTE',
    'flag_photo_validation_for_review:authenticated:EXECUTE',
    'get_entry_draft:authenticated:EXECUTE',
    ...
    'get_photo_moments_delivery:authenticated:EXECUTE',
    'get_video_moment_delivery:authenticated:EXECUTE',
    'get_video_moment_poster_delivery:authenticated:EXECUTE',
    'list_all_timeline_moments:authenticated:EXECUTE',
    'list_entry_drafts:authenticated:EXECUTE',
    'list_existing_circle_members:authenticated:EXECUTE',
    ...
    'list_my_mention_notifications:authenticated:EXECUTE',
    'list_my_photo_intakes:authenticated:EXECUTE',
    ...
    'list_visible_content_mentions:authenticated:EXECUTE',
    'list_web_push_deliveries:authenticated:EXECUTE',
    ...
    'remove_moment_photo:authenticated:EXECUTE',
    'reorder_moment_photos:authenticated:EXECUTE',
    ...
    'reserve_video_moment:authenticated:EXECUTE',
    'revoke_invitation:authenticated:EXECUTE',
    'revoke_membership:authenticated:EXECUTE',
    'save_entry_draft:authenticated:EXECUTE',
    'save_web_push_subscription:authenticated:EXECUTE',
    'set_circle_archived:authenticated:EXECUTE',
    'set_membership_role:authenticated:EXECUTE',
    'set_moment_audience:authenticated:EXECUTE',
    'set_moment_note_heart:authenticated:EXECUTE',
...
select is(
  ...
  array[
    ...
    'add_existing_circle_member(source_membership_id uuid, target_circle_id uuid)',
    'apply_content_mentions(target_moment_id uuid, target_note_id uuid, requested_user_ids uuid[], requested_starts integer[], requested_ends integer[], requested_body text)',
    'attach_photo_to_moment(requested_moment_id uuid, requested_request_key uuid)',
    'attach_staged_moment_mentions(target_moment_id uuid)',
    'attach_video_moment_poster(requested_moment_id uuid, requested_width_px integer, requested_height_px integer)',
    'can_manage_person(requested_circle_id uuid, requested_person_id uuid)',
    'can_read_live_moment(requested_moment_id uuid)',
    'can_read_moment_audience(requested_circle_id uuid, requested_audience text, requested_recorded_by_membership_id uuid)',
    'can_view_person(requested_circle_id uuid, requested_person_id uuid)',
    'cancel_photo_intake(requested_intake_id uuid)',
    'claim_mention_push_deliveries(requested_moment_id uuid, requested_note_id uuid)',
    'claim_note_reaction_push_deliveries(requested_note_id uuid)',
    ...
    'create_circle(requested_name text, source_circle_id uuid)',
    'create_family_moment(requested_circle_id uuid, requested_journal_person_id uuid, requested_kind text, requested_title text, requested_body text, requested_place_name text, requested_tagged_person_ids uuid[], requested_occurred_on date, requested_occurred_at timestamp with time zone, requested_occurred_timezone text, requested_latitude double precision, requested_longitude double precision, requested_audience text)',
    'create_insight_moment(requested_circle_id uuid, requested_quote text, requested_attribution text, requested_source_url text, requested_occurred_on date, requested_occurred_at timestamp with time zone, requested_occurred_timezone text, requested_audience text, requested_circle_ids uuid[])',
    'create_invitation(requested_circle_id uuid, invited_display_name text, invited_email text, reinvite_membership_id uuid)',
    'create_just_me_insight_for_member(requested_circle_id uuid, requested_member_person_id uuid, requested_quote text, requested_attribution text, requested_source_url text, requested_occurred_on date, requested_occurred_at timestamp with time zone, requested_occurred_timezone text)',
    ...
    'delete_web_push_subscription(requested_endpoint text)',
    ...
    'entry_draft_circles_are_allowed(requested_circle_ids uuid[])',
    ...
    'get_video_moment_poster_delivery(requested_moment_id uuid)',
    'inherit_profile_color()',
    ...
    'just_me_journal_is_recorder(requested_circle_id uuid, requested_journal_person_id uuid, requested_audience text)',
    'link_additional_moment_circles(requested_moment_id uuid, requested_circle_ids uuid[])',
    'list_entry_drafts()',
    'list_existing_circle_members(source_circle_id uuid, target_circle_id uuid)',
    'list_manageable_trashed_written_moments(requested_circle_id uuid)',
    'list_my_mention_notifications()',
    'list_my_photo_intakes(requested_circle_id uuid)',
    'list_pending_invitation_email_requests(requested_circle_id uuid)',
    'list_pending_invitations(requested_circle_id uuid)',
    'list_visible_content_mentions(moment_ids uuid[])',
    'list_web_push_deliveries(requested_activity_kind text, requested_activity_id uuid)',
    ...
    'reject_archived_circle_sharing()',
    ...
    'remove_moment_photo(requested_moment_id uuid, requested_photo_id uuid)',
    'reorder_moment_photos(requested_moment_id uuid, requested_photo_ids uuid[])',
    ...
    'reserve_photo_moment(requested_circle_id uuid, requested_journal_person_id uuid, requested_body text, requested_place_name text, requested_tagged_person_ids uuid[], requested_occurred_on date, requested_occurred_at timestamp with time zone, requested_occurred_timezone text, requested_request_key uuid, requested_audience text)',
    'reserve_video_moment(requested_circle_id uuid, requested_journal_person_id uuid, requested_body text, requested_place_name text, requested_tagged_person_ids uuid[], requested_occurred_on date, requested_expected_mime_type text, requested_expected_size_bytes bigint, requested_duration_ms integer, requested_occurred_at timestamp with time zone, requested_occurred_timezone text, requested_request_key uuid, requested_audience text, requested_existing_moment_id uuid)',
    ...
    'save_entry_draft(requested_id uuid, requested_kind text, requested_title text, requested_body text, requested_audience text, requested_circle_ids uuid[], requested_journal_person_id uuid, requested_tagged_person_ids uuid[], requested_place_name text, requested_latitude double precision, requested_longitude double precision, requested_occurred_on date, requested_occurred_time text, requested_occurred_timezone text, requested_media jsonb, requested_verse jsonb)',
    'save_web_push_subscription(requested_endpoint text, requested_p256dh text, requested_auth text)',
    'set_circle_archived(target_circle_id uuid, archive boolean)',
    'set_membership_role(target_membership_id uuid, requested_role text)',
    'set_moment_audience(target_moment_id uuid, expected_revision bigint, requested_audience text, requested_circle_ids uuid[])',
    'set_moment_note_heart(target_note_id uuid, requested_hearted boolean)',
    ...
    'share_private_moment(moment_id uuid, expected_revision bigint, destination_circle_id uuid, moment_title text, moment_body text, place_name text, tagged_person_ids uuid[], occurred_on date, occurred_at timestamp with time zone, occurred_timezone text, latitude double precision, longitude double precision)',
    'stage_media_mentions(requested_kind text, requested_request_id uuid, requested_user_ids uuid[], requested_starts integer[], requested_ends integer[], requested_body text)',
    ...
    'update_circle(requested_circle_id uuid, requested_name text)',
    'update_family_moment(target_moment_id uuid, expected_revision bigint, requested_title text, requested_body text, requested_place_name text, requested_tagged_person_ids uuid[], requested_occurred_on date, requested_occurred_at timestamp with time zone, requested_occurred_timezone text, requested_latitude double precision, requested_longitude double precision, requested_audience text)',
    ...
    'video_object_path_is_readable(requested_object_path text)',
