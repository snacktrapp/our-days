...
select is(
  ...
  array[
    ...
    'create_family_moment(circle_id uuid, journal_person_id uuid, moment_kind text, moment_title text, moment_body text, place_name text, tagged_person_ids uuid[], occurred_on date, occurred_at timestamp with time zone, occurred_timezone text, latitude double precision, longitude double precision)',
    ...
    'reserve_video_moment(circle_id uuid, journal_person_id uuid, body text, place_name text, tagged_person_ids uuid[], occurred_on date, expected_mime_type text, expected_size_bytes bigint, duration_ms integer, occurred_at timestamp with time zone, occurred_timezone text, request_key uuid)',
    ...
    'update_family_moment(moment_id uuid, expected_revision bigint, moment_title text, moment_body text, place_name text, tagged_person_ids uuid[], occurred_on date, occurred_at timestamp with time zone, occurred_timezone text, latitude double precision, longitude double precision)',
